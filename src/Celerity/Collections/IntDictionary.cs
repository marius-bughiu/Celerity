    ...
    where THasher : struct, IHashProvider<int>
{
    ...
    public void CopyTo(KeyValuePair<int, TValue?>[] array, int arrayIndex)
    {
        ...
        int i = arrayIndex;
        foreach (KeyValuePair<int, TValue?> entry in this)
            array[i++] = entry;
    }
    ...
    public readonly struct KeyCollection : ICollection<int>
    {
        ...
        public bool Contains(int item) => _dict.ContainsKey(item);
        ...
        public void CopyTo(int[] array, int arrayIndex)
        {
            ...
            int i = arrayIndex;
            foreach (KeyValuePair<int, TValue?> entry in _dict)
                array[i++] = entry.Key;
        }
    ...
    // IDictionary<int, TValue?> explicit interface members. Everything the mutable
