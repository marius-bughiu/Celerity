...
public class LoadFactorBoundaryTests
{
    ...
    // ---------------------------------------------------------------
    //  SwissDictionary — low load factor
    // ---------------------------------------------------------------

    [Fact]
    public void SwissDictionary_LowLoadFactor_TriggersEarlyResize_AndPreservesAllData()
    {
    ...
    // ---------------------------------------------------------------
    //  SwissDictionary — high load factor
    // ---------------------------------------------------------------

    [Fact]
    public void SwissDictionary_HighLoadFactor_PermitsHighDensity_AndPreservesAllData()
    {
        var map = new SwissDictionary<int, int, Int32WangNaiveHasher>(
            capacity: 16, loadFactor: 0.95f);
    ...
    // ---------------------------------------------------------------
    //  SwissDictionary — multiple sequential resizes
    // ---------------------------------------------------------------

    [Fact]
    public void SwissDictionary_TinyInitialCapacity_MultipleResizes_PreserveAllEntries()
    {
        var map = new SwissDictionary<int, int, Int32WangNaiveHasher>(
            capacity: 16, loadFactor: 0.5f);
    ...
    // ---------------------------------------------------------------
    //  SwissDictionary — default key with load-factor boundary
    // ---------------------------------------------------------------
    ...
    [Fact]
    public void SwissDictionary_DefaultKey_InsertsBeforeThreshold_DoesNotCorruptResizeTiming()
    {
        var map = new SwissDictionary<int, int, Int32WangNaiveHasher>(
            capacity: 16, loadFactor: 0.5f);
        map[0] = -1;
    ...
    [InlineData(0.75f)]
    [InlineData(0.95f)]
    public void SwissDictionary_VariousLoadFactors_AllDataSurvivesMultipleResizes(float loadFactor)
    {
        var map = new SwissDictionary<int, int, Int32WangNaiveHasher>(
