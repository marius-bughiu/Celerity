...
/// <see cref="RobinHoodDictionary{TKey, TValue, THasher}"/>. These tests cover
...
public class RemoveOutValueTests
{
    ...
    [Fact]
    public void RobinHoodDictionary_RemoveOutValue_ReturnsTrueAndCapturedValue_ForExistingKey()
    {
    ...
    [Fact]
    public void RobinHoodDictionary_RemoveOutValue_ReturnsFalseAndDefault_ForMissingKey()
    {
        var map = new RobinHoodDictionary<int, string, Int32WangNaiveHasher>();
        map[1] = "one";
    ...
    [Fact]
    public void RobinHoodDictionary_RemoveOutValue_CapturesDefaultIntKeyValue()
    {
        // default(int) == 0 lives in the out-of-band slot for RobinHood too.
        var map = new RobinHoodDictionary<int, string, Int32WangNaiveHasher>();
        map[0] = "zero";
        map[1] = "one";
    ...
    [Fact]
    public void RobinHoodDictionary_RemoveOutValue_CapturesNullStringKeyValue()
    {
        // For reference-type keys the out-of-band slot stores the null key;
        // the captured value must come from that slot.
    ...
    [Fact]
    public void RobinHoodDictionary_RemoveOutValue_ReturnsFalse_WhenDefaultKeyAbsent()
    {
        var map = new RobinHoodDictionary<int, string, Int32WangNaiveHasher>();
        map[1] = "one";
    ...
    [Fact]
    public void RobinHoodDictionary_RemoveOutValue_RehashesCluster_UnderFullCollision()
    {
    ...
    [Fact]
    public void RobinHoodDictionary_RemoveOutValue_BumpsVersion_AndInvalidatesEnumerator()
    {
    ...
    [Fact]
    public void SwissDictionary_RemoveOutValue_ReturnsTrueAndCapturedValue_ForExistingKey()
    {
    ...
    [Fact]
    public void SwissDictionary_RemoveOutValue_ReturnsFalseAndDefault_ForMissingKey()
    {
        var map = new SwissDictionary<int, string, Int32WangNaiveHasher>();
        map[1] = "one";
    ...
    [Fact]
    public void SwissDictionary_RemoveOutValue_CapturesDefaultIntKeyValue()
    {
        var map = new SwissDictionary<int, string, Int32WangNaiveHasher>();
        map[0] = "zero";
        map[1] = "one";
    ...
    [Fact]
    public void SwissDictionary_RemoveOutValue_CapturesNullStringKeyValue()
    {
    ...
    [Fact]
    public void SwissDictionary_RemoveOutValue_ReturnsFalse_WhenDefaultKeyAbsent()
    {
        var map = new SwissDictionary<int, string, Int32WangNaiveHasher>();
        map[1] = "one";
    ...
    [Fact]
    public void SwissDictionary_RemoveOutValue_RehashesCluster_UnderFullCollision()
    {
    ...
    [Fact]
    public void SwissDictionary_RemoveOutValue_BumpsVersion_AndInvalidatesEnumerator()
    {
    ...
    [Fact]
    public void HashCachingDictionary_RemoveOutValue_ReturnsTrueAndCapturedValue_ForExistingKey()
    {
    ...
    [Fact]
    public void HashCachingDictionary_RemoveOutValue_ReturnsFalseAndDefault_ForMissingKey()
    {
        var map = new HashCachingDictionary<int, string, Int32WangNaiveHasher>();
        map[1] = "one";
    ...
    [Fact]
    public void HashCachingDictionary_RemoveOutValue_CapturesDefaultIntKeyValue()
    {
        var map = new HashCachingDictionary<int, string, Int32WangNaiveHasher>();
        map[0] = "zero";
        map[1] = "one";
    ...
    [Fact]
    public void HashCachingDictionary_RemoveOutValue_CapturesNullStringKeyValue()
    {
    ...
    [Fact]
    public void HashCachingDictionary_RemoveOutValue_ReturnsFalse_WhenDefaultKeyAbsent()
    {
        var map = new HashCachingDictionary<int, string, Int32WangNaiveHasher>();
        map[1] = "one";
    ...
    [Fact]
    public void HashCachingDictionary_RemoveOutValue_RehashesCluster_UnderFullCollision()
    {
    ...
    [Fact]
    public void HashCachingDictionary_RemoveOutValue_BumpsVersion_AndInvalidatesEnumerator()
    {
    ...
    [Fact]
    public void RobinHoodDictionary_VoidRemove_StillReturnsTrueForFoundKey()
    {
        var map = new RobinHoodDictionary<int, string, Int32WangNaiveHasher>();
        map[1] = "one";
    ...
    [Fact]
    public void SwissDictionary_VoidRemove_StillReturnsTrueForFoundKey()
    {
        var map = new SwissDictionary<int, string, Int32WangNaiveHasher>();
        map[1] = "one";
    ...
    [Fact]
    public void HashCachingDictionary_VoidRemove_StillReturnsTrueForFoundKey()
    {
        var map = new HashCachingDictionary<int, string, Int32WangNaiveHasher>();
        map[1] = "one";
