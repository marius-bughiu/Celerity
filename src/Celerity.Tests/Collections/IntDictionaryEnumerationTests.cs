...
// Milestone 1.1.0 — issue #10: Keys / Values / GetEnumerator on IntDictionary.
//
// These tests pin down the observable behavior of the new struct enumerators
// and the Keys / Values collection views:
// - GetEnumerator yields every key/value pair exactly once (including the
//   out-of-band zero-key entry).
...
//   on the next MoveNext — matching BCL Dictionary semantics.
public class IntDictionaryEnumerationTests
{
    [Fact]
    ...
    public void MoveNext_ShouldThrow_WhenZeroKeyInsertedDuringEnumeration()
    {
        ...
        map[0] = 0; // zero-key insert goes through the out-of-band slot.
