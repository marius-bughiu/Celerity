...
// Issue #64 — Keys / Values / GetEnumerator on SwissDictionary.
//
// Mirror of CelerityDictionaryEnumerationTests / RobinHoodDictionaryEnumerationTests
// for the Swiss-table variant. Exercises the struct enumerators, KeyCollection,
// ValueCollection, the out-of-band default-key entry (including null keys for
// reference types), and mid-enumeration mutation detection.
public class SwissDictionaryEnumerationTests
{
    [Fact]
