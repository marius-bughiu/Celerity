...
// Enumeration tests for HashCachingSet, mirroring CeleritySetEnumerationTests /
...
public class HashCachingSetEnumerationTests
{
    [Fact]
    ...
    {
        var set = new HashCachingSet<int, Int32WangNaiveHasher>(capacity: 16);
        for (int i = 1; i <= 200; i++)
            set.Add(i);
    ...
    public void GetEnumerator_ShouldSkipRemovedSlots()
    {
        ...
        var set = new HashCachingSet<int, Int32WangNaiveHasher>(64);
        for (int i = 1; i <= 40; i++)
            set.Add(i);
    ...
    {
        var set = new HashCachingSet<int, Int32Murmur3Hasher>();
        set.Add(0);
        for (int i = 1; i <= 25; i++)
            set.Add(i);
