...
// Milestone 1.2.0 — issue #61: GetEnumerator / Keys / Values on SmallDictionary.
//
// Mirrors IntDictionaryEnumerationTests for the flat-array dictionary. The
// out-of-band zero-key cases collapse into ordinary-entry cases (SmallDictionary
// hashes nothing), and the "resize" case asserts the grow-and-keep-scanning path.
public class SmallDictionaryEnumerationTests
{
    [Fact]
    ...
    [Fact]
    public void GetEnumerator_ShouldIncludeZeroAndNullKeyEntries()
    {
    ...
    [Fact]
    public void Values_ShouldYieldEveryValueExactlyOnce()
    {
        var map = new SmallDictionary<int, string>();
        map[0] = "zero";
        map[1] = "one";
