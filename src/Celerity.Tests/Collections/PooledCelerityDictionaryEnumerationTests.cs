...
// Mirror of CelerityDictionaryEnumerationTests for the pooled dictionary: struct
// enumerators, Keys / Values views, the out-of-band default-key entry (including
// null keys), mid-enumeration mutation detection, and the boxed / non-generic
// IEnumerable paths — all over rented backing arrays bounded by the logical size.
public class PooledCelerityDictionaryEnumerationTests
{
    [Fact]
