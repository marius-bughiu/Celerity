...
public class StringHighwayHash64HasherTests
{
    ...
    /// <summary>
    /// The hasher computes 64 bits of HighwayHash64 state internally and used to throw half of it
    ...
    public void Hash64_MatchesReferenceImplementation_AndFoldsToHash()
    {
        ...
        {
            ulong expected = ReferenceHighway64(Encoding.Unicode.GetBytes(s), TestKey);
