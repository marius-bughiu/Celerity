...
public class UInt64Murmur3HasherTests
{
    ...
    [Fact]
    public void Hash_ShouldReturnZero_WhenTheKeyIsZero()
    {
    ...
    public void Hash64_ShouldReturnTheDocumentedCode_WhenGivenAKnownKey(ulong input, ulong expected)
    {
    ...
    [Fact]
    public void Hash64_ShouldAgreeAcrossInstances_WhenTheHasherIsDefaultConstructed()
    {
        Assert.Equal(new UInt64Murmur3Hasher().Hash64(42UL), default(UInt64Murmur3Hasher).Hash64(42UL));
    }

    [Fact]
    public void Hash_ShouldNotCollide_OverASmallSequentialRange()
    {
