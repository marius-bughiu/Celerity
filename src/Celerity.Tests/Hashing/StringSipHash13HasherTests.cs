...
public class StringSipHash13HasherTests
{
    ...
    /// <summary>
    /// The hasher computes 64 bits of SipHash-1-3 state internally and used to throw half of it
    ...
    public void Hash64_MatchesReferenceImplementation_AndFoldsToHash()
    {
        ...
        {
            ulong expected = SipHash(Encoding.Unicode.GetBytes(s), cRounds: 1, dRounds: 3);
