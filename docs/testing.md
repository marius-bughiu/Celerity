...
**Not universal, and here is the gap.** `EnumMap`, `XorFilter` and `TopKSketch` have no differential coverage anywhere. They have behavioural tests and are inside the 100% line-and-branch gate, but nothing compares them to an oracle over a sequence nobody wrote down. Tracked in [#418](https://github.com/marius-bughiu/Celerity/issues/418).
